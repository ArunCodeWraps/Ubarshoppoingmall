  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="row">
          <div class="col-md-3 listpage"><h4>Manage Sub Sub Category</h4></div>
          ...
          <div class="col-md-3"><p style="text-align:right">
            <span><input type="button" name="add" value="Add Sub Category"  class="button" onClick="location.href='subsubcategory-addf.php'" /></span>	
          </p>
        </div>
      </div>
    </section>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $i=1;
                    $sql=$obj->query("select * from $tbl_subsubcategory where 1=1",$debug=-1);
                    while($line=$obj->fetchNextObject($sql)){?>
                      ...
                      <td><?php echo getField('subcategory',$tbl_subcategory,$line->subcat_id); ?></td>
                      <td><?php echo stripslashes($line->subsubcategory); ?></td>
                      <td align="center">

                          <label class="switch">
                            <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_subsubcategory?>">
                            <div class="slider round"></div>
                          </label>

                        </td>
                        <td><a href="subsubcategory-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
                        </td>
                      </tr>
                      <?php $i++; }?>
...
if(comb=='Delete'){
  ...
  {
    frmobj.action = "subsubcategory-del.php";
