  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="row">
          <div class="col-md-3 listpage"><h4>Manage Color</h4></div>
          ...
          <div class="col-md-3"><p style="text-align:right">
            <span><input type="button" name="add" value="Add Color"  class="button" onClick="location.href='color-addf.php'" /></span>  
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
          <form name="frm" method="post" action="color-del.php" enctype="multipart/form-data">
            <div class="box">
              <div class="box-body">
                <table id="city-grid" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $i=1;
                    $sql=$obj->query("select * from $tbl_color where 1=1",$debug=-1);
                    while($line=$obj->fetchNextObject($sql)){?>
                      <tr>
                        ...
                        <td><?php echo ucfirst(stripslashes($line->color_name)); ?></td>
                        <td><?php echo stripslashes($line->color_code); ?></td>
                        <td align="center">
                          <label class="switch">
                            <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_color?>">
                            <div class="slider round"></div>
                          </label>
                        </td>
                        <td><a href="color-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
                        </td>
                      </tr>
                      <?php $i++; }?>
                    </tbody>
