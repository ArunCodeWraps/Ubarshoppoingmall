...
$sql = "select a.id,a.vendor_id,a.product_name,a.product_code,a.cat_id,a.subcat_id,a.brand_id,a.status,a.display_order,a.subsubcat_id from $tbl_product as a join $tbl_productprice as b on a.id=b.product_id where 1=1";
...
while($row=$obj->fetchNextObject($query)) {  // preparing an array
	...
	$nestedData[] = getField('category',$tbl_category,$row->cat_id)."->".getField('subcategory',$tbl_subcategory,$row->subcat_id)."->".getField('subsubcategory',$tbl_subsubcategory,$row->subsubcat_id);
