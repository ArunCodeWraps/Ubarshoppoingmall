 <header class="main-header">
    ...
    <a href="welcome.php" class="logo">
      <img src="../img/logo.png" class="user-image" alt="User Image" style="height: 51px; width: 194px;">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
           ...
           <li class="dropdown user user-menu">
              ...
              <a href="../index.html" target="_blank"><img src="images/computer.png" class="user-image" alt="User Image"> <span class="hidden-xs">Visit Website</span></a>
